...
class Args:
    def __init__(self):
        ...
        # self.graph_type = 'caveman_small_base'
        # self.graph_type = 'community_small'
        # self.graph_type = 'citeseer_base'
        self.bfs = "nobfs"
        # self.graph_type = 'grid_small'
        # self.graph_type = 'ladder_small'
        self.graph_type = "community_small"
        # self.graph_type = 'community_large'
        # self.graph_type = 'enzymes'
        # self.graph_type = 'enzymes_small'
        # self.graph_type = 'barabasi'
        # self.graph_type = 'barabasi_small'
        # self.graph_type = 'citeseer'
        # self.graph_type = 'DD_fermat'
        # self.graph_type = 'Ego_large'
        # self.graph_type = 'Ego_fermat'
        ...
        self.epochs = 800  # now one epoch means self.batch_ratio x batch_size
        ...
        self.model_save_path = (
            self.dir_input + "model_savesingle/"
        ...
        ### single config
        # self.generator_base = 'Gnp'
        self.generator_base = "BA"

        # self.metric_base = 'general'
        # self.metric_base = 'degree'
        self.metric_base = "clustering"

        ### filenames to save intemediate and final outputs

        # self.fname = self.note + '_' + "Community" + '_' + str(self.num_layers) + '_' + str(self.hidden_size_rnn) + '_'
        # self.fname_pred = self.note+'_'+"Community"+'_'+str(self.num_layers)+'_'+ str(self.hidden_size_rnn)+'_pred_'
        # self.fname_train = self.note+'_'+"Community"+'_'+str(self.num_layers)+'_'+ str(self.hidden_size_rnn)+'_train_'
        # self.fname_test = self.note + '_' + "Community"+ '_' + str(self.num_layers) + '_' + str(self.hidden_size_rnn) + '_test_'
        # self.fname_base = self.graph_save_path + "Community" + self.generator_base+'_'+self.metric_base

        # self.fname = self.note + '_' + "Ego_perm_base" + '_' + str(self.num_layers) + '_' + str(self.hidden_size_rnn) + '_'
        self.fname = (
            self.note
            + "_"
            + "noise_single_update"
