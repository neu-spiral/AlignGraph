...
class GCNModelVAE(Model):
    def __init__(
        self, placeholders, dims, num_nodes, features_nonzero, centre="false", **kwargs
    ):
        ...
        if centre == "false":
            ...
            print("***reading centre graph***")
            self.inputs = placeholders["features0"]
            self.adj = placeholders["adj0"]
        self.features_nonzero = features_nonzero
    ...
    def _build(self):
        ...
        self.z = self.z_mean + tf.compat.v1.random_normal(
