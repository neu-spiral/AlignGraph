...
def compute_mmd(samples1, samples2, kernel, is_hist=True, *args, **kwargs):
    ...
    # print("disc(samples1, samples1, kernel, *args, **kwargs)", disc(samples1, samples1, kernel, *args, **kwargs))
    # print("disc(samples2, samples2, kernel, *args, **kwargs)", disc(samples2, samples2, kernel, *args, **kwargs))
    # print("disc(samples1, samples2, kernel, *args, **kwargs)", disc(samples1, samples2, kernel, *args, **kwargs))
